...
function Info1() {
    return (
        <section className="w-screen h-screen flex items-center justify-center snap-start bg-gradient-to-br from-blue-50 to-indigo-100">
            <div className="max-w-3xl mx-auto p-8 bg-white rounded-lg shadow-lg transform transition-all duration-100 hover:scale-105">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                    ...
                    Tas attiecas uz datu organizēšanu un saistībām.
                </p>
            </div>
        </section>
    );
